				...
				<section className="ServicesContainer">
					...
					<div className="ListContainer">
						<ServiceCard imageSrc="/images/priscilla-du-preez-Q7wGvnbuwj0-unsplash1.png">
							...
							convivial afin de valoriser votre société en projetant une image dynamique. Nous
							vous proposons d’organiser pour vous vos diners et soirée d’entreprise
						</ServiceCard>
						<ServiceCard imageSrc="/images/hall-expo.png">
							<h3>Conférences</h3>
							77 events vous propose d’organiser votre évènement, quelle que soit sa taille,
							en s’adaptant à votre demande et à vos demandes. En tant que spécialistes de
							l’évènementiel, nous saurons trouver le lieu parfait ainsi que des solutions
						...
						<ServiceCard imageSrc="/images/sophia-sideri-LFXMtUuAKK8-unsplash1.png">
							...
							entreprises, pour l’utilisation de la réalité virtuelle, de la réalité augmentée
							et de la réalité mixte de l’animation événementielle, à la veille technologique
					...
					<Modal
						Content={
							<div className="ModalMessage--success">
								...
								<p>
									Merci pour votre message nous tâcherons de vous répondre dans les plus brefs
									délais
								</p>
							</div>
						}>
			...
			<footer className="row">
				...
				<div className="col description">
					...
					<p>
						...
						événements festifs, des manifestations sportives et culturelles, des événements
						professionnels
					</p>
				</div>
			</footer>
